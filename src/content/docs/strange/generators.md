...
<a name="Generators+changemymind"></a>
...
<a name="Generators+discordblue"></a>
...
<a name="Generators+jokeoverhead"></a>
...
<a name="Generators+lisaPresentation"></a>
...
### generators.stonk(options) ⇒ <code>ArrayBuffer</code>
